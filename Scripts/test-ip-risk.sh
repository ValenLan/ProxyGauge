...
/usr/bin/grep -Fq '个查询源确认出口一致' "$PROJECT_ROOT/Scripts/proxygauge-check.sh"
/usr/bin/grep -Fq '触发 Cloudflare challenge' "$PROJECT_ROOT/Scripts/proxygauge-check.sh"
...
/usr/bin/grep -Fq 'https://browserleaks.com/ip' "$PROJECT_ROOT/Sources/DashboardView.swift"
/usr/bin/grep -Fq 'https://ippure.com/' "$PROJECT_ROOT/Sources/DashboardView.swift"
/usr/bin/grep -Fq 'https://ipcheck.ing/?hl=zh' "$PROJECT_ROOT/Sources/DashboardView.swift"
/usr/bin/grep -Fq 'https://www.ipqualityscore.com/free-ip-lookup-proxy-vpn-test' "$PROJECT_ROOT/Sources/DashboardView.swift"
...
echo "ProxyGauge IP risk and portable rule pack tests passed."
